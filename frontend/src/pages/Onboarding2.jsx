...
const levelOptions = [
  {
    emoji: "🌱",
    label: "Beginner — still figuring out what an API is",
    value: "beginner"
  },
  {
    emoji: "📈",
    label: "Intermediate — lowkey obsessed with AI tools", value: "intermediate"
  },
  {
    emoji: "🔥",
    label: "Advanced — built stuff, broke stuff, learned stuff",
    value: "advanced"
  },
];
...
function Onboarding2() {
  ...
  const handleContinue = () => {
    ...
    const selectedLabel = levelOptions.find((opt) => opt.value === selected)?.label;
    sessionStorage.setItem("onboarding_step2", selectedLabel);
  ...
  return (
    <div style={styles.wrapper}>
      ...
      <div style={styles.topBar}>
        ...
        <div style={styles.progressInfo}>2 of 3</div>
      </div>
      ...
      <div style={styles.content}>
        <div style={styles.stepPill}>⚡ Step 2</div>

        <h1 style={styles.h1}>
          how much do you<br />already know?
        </h1>
